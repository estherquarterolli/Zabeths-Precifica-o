...
<?php if ($erro): ?>
    <div class="alert error">Não foi possível carregar o histórico: <?= h($erro) ?></div>
<?php elseif (isset($_GET['excluido'])): ?>
    <div class="alert success">Registro excluído com sucesso.</div>
<?php endif; ?>
        ...
        <?php foreach ($historico as $p): ?>
            <tr>
                ...
                <td class="actions-cell">
                    <a class="btn small secondary" href="produto_view.php?linha=<?= (int) $p['linha'] ?>">Ver</a>
